    ...
    useEffect(() => {
      const fetchUserData = async () => {
        try {
          ...
          const querySnapshot = await getDocs(query(collection(firestore, "places"), where("placetripid", "==", userId)));
                ...
                <TableBody>
                  {tripData.map((user, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell>Latitude: {user.placestart.latitude ?? "N/A"}, Longitude: {user.placestart.longitude ?? "N/A"}</TableCell>
                      <TableCell>
                          {user.placetimestart
                            ? `${user.placetimestart
                                .toDate()
                                .toLocaleDateString("th-TH")} ${user.placetimestart
                                .toDate()
                        ...
                        <TableCell>
                          {user.placetimeend
                            ? `${user.placetimeend
                                .toDate()
                                .toLocaleDateString("th-TH")} ${user.placetimeend
                                .toDate()
                                .toLocaleTimeString("th-TH")}`
                            : "N/A"}
                        </TableCell>
